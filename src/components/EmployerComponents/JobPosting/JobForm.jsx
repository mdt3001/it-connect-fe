...
import { MapPin, DollarSign, Clock, Tag, FileText, ListChecks, Eye, Send, Building2 } from "lucide-react";
            ...
            <form onSubmit={(e) => { e.preventDefault(); onSubmit(); }} className="space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <FormField label="Lương tối thiểu" error={errors.salaryMin} className="col-span-1">
                        ...
                        <FormField label="Lương tối đa" error={errors.salaryMax} className="col-span-1">
                            <IconInput icon={DollarSign}>
                                <input
                                    type="number"
                                    className="w-full border border-gray-300 rounded pl-10 pr-3 py-2"
